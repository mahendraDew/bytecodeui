    ...
    <div className=''>
      <div className='w-[85%] max-w-[1280px] min-w-[320px] my-[10px] mx-auto h-auto self-start relative flex'>
        <div className='relative w-full max-w-[1280px] min-w-[320px] h-auto pt-[58.6%] m-0 bg-contain bg-center bg-no-repeat box-border'>
          ...
          <div className='w-[99.75%] h-[7.6%] mx-auto absolute bottom-0 left-0 right-0 z-[100] flex flex-wrap justify-center'>
            <div className='w-full h-[37.25%] absolute mx-auto left-0 right-0 top-0 bg-gradient-to-r from-[#68696b] via-[#e8e9eb] to-[#68696b] z-[100] rounded-[1px] flex justify-center items-start'>
              <div className='relative w-[6.917%] h-[65.5%] z-[101] rounded-bl-[20px] bg-[#c1c2c6] bg-gradient-to-b from-[rgba(195,198,200,0.5)] via-[rgba(199,200,204,0.5)] to-[rgba(115,125,130,0.4)]'></div>
              <div className='relative w-[6.917%] h-[65.5%] z-[101] rounded-br-[20px] bg-[#c1c2c6] bg-gradient-to-b from-[rgba(195,198,200,0.5)] via-[rgba(199,200,204,0.5)] to-[rgba(115,125,130,0.4)]'></div>
            </div>
            <div className='relative block w-1/2 h-[58%] top-[10%] z-[99] bg-gradient-to-b from-[#e5e6e9] via-[#909193] to-[#29292b] rounded-bl-[25%] rounded-bl-[60%]'></div>
            <div className='relative block w-1/2 h-[58%] top-[10%] z-[99] bg-gradient-to-b from-[#e5e6e9] via-[#909193] to-[#29292b] rounded-br-[25%] rounded-br-[60%]'></div>
            <div className='w-[95%] h-[60%] flex justify-center'>
              <div className='relative block w-1/2 h-full top-[10%] z-[90] bg-gradient-to-b from-black via-[rgba(8,11,17,0.85)] to-transparent rounded-tl-[20%] rounded-tl-[90%] blur-[2px]'></div>
              <div className='relative block w-1/2 h-full top-[10%] z-[90] bg-gradient-to-b from-black via-[rgba(8,11,17,0.85)] to-transparent rounded-tr-[20%] rounded-tr-[90%] blur-[2px]'></div>
            </div>
          </div>
        </div>
      </div>
